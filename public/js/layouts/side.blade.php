...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light {{$value}}">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class=" btn btn-info" href="{{route('vehicle_slip.create')}}">Vehicle Slip</a>
        </li>
        <li class="nav-item">
            <a class=" btn btn-danger" href="{{route('account_transactions.create')}}">Account Transaction</a>
        </li>
        <li class="nav-item">
            <a class=" btn btn-success" href="{{route('weekly_report.create')}}">Weekly Report</a>
        </li>
        <li class="nav-item">
            <a class=" btn btn-warning" href="{{route('account_heads.create')}}">Account Head</a>
        </li>
